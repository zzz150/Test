package com.yunerp.base.generator;
...
public class ResourceManager {
	...
	private static void loadProperties() {
		if (props == null) {
			...
			try {
				InputStream in = ResourceManager.class.getClassLoader()
			...
			JDBC_URL = props.getProperty("saveUrl");
			JDBC_USER = props.getProperty("dbUsername");
			JDBC_PASSWORD = props.getProperty("dbPassword");
		}
	}
	/**
	 * 得到属性信息
